...
MUSIC_BOT_NAME = getenv("MUSIC_BOT_NAME", "9𝚡𝚖 ✘ 𝐌ʋsɩƈ")
OWNER_ID = list(map(int, getenv("OWNER_ID", "5379949226").split()))
HEROKU_API_KEY = getenv("HEROKU_API_KEY", None)
HEROKU_APP_NAME = getenv("HEROKU_APP_NAME", None)
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/Anup8273/Mistysanki")
UPSTREAM_BRANCH = getenv("UPSTREAM_BRANCH", "yamraj")
GIT_TOKEN = getenv("GIT_TOKEN", None)
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/mistyamraj_ki_kahani")
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "https://t.me/best_friends_chettnig_grup")
...
PING_IMG_URL = getenv("PING_IMG_URL", "https://graph.org/file/8d9e371416200df4097a2.jpg")

PLAYLIST_IMG_URL = "https://graph.org/file/7b39acb6eede7147d3183.jpg"
GLOBAL_IMG_URL = "https://graph.org/file/409e03a7208b104046f9a.jpg"
