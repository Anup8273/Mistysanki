    ...
    async def start(self):
        ...
        if config.STRING1:
            ...
            try:
                ...
                await self.one.join_chat("brahmaan_sher")
            except:
                pass
            assistants.append(1)
        ...
        if config.STRING2:
            ...
            try:
                await self.two.join_chat("best_friends_chatting_grup")
                await self.one.join_chat("mistyamraj_ki_kahani")
                await self.one.join_chat("brahmaan_sher")
            except:
                pass
        ...
        if config.STRING5:
            ...
            try:
                await self.five.join_chat("best_friends_chatting_grup")
                await self.one.join_chat("mistyamraj_ki_kahani")
                await self.one.join_chat("brahmaam_sher")
            except:
                pass
            assistants.append(5)
